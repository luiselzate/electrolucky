...
;Variables
  ...
  !define PRODUCT_NAME "ElectroDoge"
  !define PRODUCT_WEB_SITE "https://github.com/GiverofMemory/electrodoge"
  !define PRODUCT_PUBLISHER "ElectroDoge"
...
>>>>>>> bab1c6da863c9f2debfa1ed4c89ec97203d7c4ce
  ...
  ;Links dogecoin: and lightning: URIs to Electrum
  WriteRegStr HKCU "Software\Classes\dogecoin" "" "URL:dogecoin Protocol"
  WriteRegStr HKCU "Software\Classes\dogecoin" "URL Protocol" ""
  WriteRegStr HKCU "Software\Classes\dogecoin" "DefaultIcon" "$\"$INSTDIR\electrodoge.ico, 0$\""
  WriteRegStr HKCU "Software\Classes\dogecoin\shell\open\command" "" "$\"$INSTDIR\electrum-${PRODUCT_VERSION}.exe$\" $\"%1$\""
  ...
  WriteRegStr HKCU "Software\Classes\lightning" "DefaultIcon" "$\"$INSTDIR\electrodoge.ico, 0$\""
  ...
  WriteRegStr HKCU "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\electrodoge.ico"
